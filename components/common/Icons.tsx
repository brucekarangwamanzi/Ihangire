...
export const BookmarkIcon = ({ saved }: { saved: boolean }) => (
...
export const GoogleIcon = () => (
    <svg className="w-5 h-5" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512">
        <path fill="currentColor" d="M488 261.8C488 403.3 381.5 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 126 23.4 172.9 61.9l-76.3 76.3c-24.5-23.4-58.2-37.8-96.6-37.8-77.8 0-141.2 63.4-141.2 141.2s63.4 141.2 141.2 141.2c86.3 0 123.3-63.4 128.8-93.5H248v-85.3h236.1c2.3 12.7 3.9 24.9 3.9 41.4z"></path>
    </svg>
);
